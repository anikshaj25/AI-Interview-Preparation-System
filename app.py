...
if menu=="Home":
    ...
    st.success("Start your preparation journy today")
    ...
    st.title("Rate yourself out of 100")
    ...
    if not st.session_state.scores:
        ...
        strong_topics=[k for k, v in scores.items() if v>50 ]

        col1.metric("Average Score", f"{avg_score:.2f}%")
        col2.metric("Weakk Topics",len(weak_topics))
